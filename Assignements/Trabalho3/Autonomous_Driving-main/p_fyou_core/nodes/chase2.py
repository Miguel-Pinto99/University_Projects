...
class TurtleBot():
    ...
    def chasing(self,center_x,chase_forward, image_width,flee,center_x_flee):
        ...
        # ---------------Walls-----------------------------
        elif regions['front'] < lim  and regions['front'] > lim/3 and regions['fleft'] > lim/2 and regions['fright'] > lim/2 and  chase_forward ==False: #and regions['fleft'] < lim and regions['fright'] < lim
        ...
        elif regions['front'] < lim/4 and regions['fleft'] > lim and regions['fright'] > lim and chase_forward == False:
